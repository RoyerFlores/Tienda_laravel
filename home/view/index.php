    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-primary text-uppercase ms-lg-3 text-dark fw-bold" href="../../page/view/login.php">
                                Iniciar Sesión
                            </a>
                        </li>
                    </ul>
        ...
        <header class="masthead" id="inicio">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">Iniciar Sesion</a>
            </div>
        </header>
        <!-- Productos-->
                ...
                <div class="row" id="productGrid">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 product-card" data-category="Ropa" data-name="Camiseta Básica">
                        <div class="card h-100">
                            <img src="../assets/assets/img/portfolio/1.jpg" class="card-img-top" alt="Producto">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 product-card" data-category="Electrónica" data-name="Auriculares Bluetooth">
                        <div class="card h-100">
                            <img src="../assets/assets/img/portfolio/2.jpg" class="card-img-top" alt="Producto">
                            <div class="card-body text-center">
                ...
                <div id="productosCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-md-3">
                                    <img src="../assets/assets/img/portfolio/1.jpg" class="d-block w-100 rounded" alt="Producto 1">
                                ...
                                <div class="col-md-3">
                                    <img src="../assets/assets/img/portfolio/2.jpg" class="d-block w-100 rounded" alt="Producto 2">
                                    <div class="text-center mt-2">
                                        <h5>Producto 2</h5>
                                        <p class="text-muted">Descripción breve.</p>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <img src="../assets/assets/img/portfolio/3.jpg" class="d-block w-100 rounded" alt="Producto 3">
                                    <div class="text-center mt-2">
                                        <h5>Producto 3</h5>
                                        <p class="text-muted">Descripción breve.</p>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <img src="../assets/assets/img/portfolio/4.jpg" class="d-block w-100 rounded" alt="Producto 4">
                                    <div class="text-center mt-2">
                                        <h5>Producto 4</h5>
                                        <p class="text-muted">Descripción breve.</p>
                                    </div>
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <img src="../assets/assets/img/portfolio/5.jpg" class="d-block w-100 rounded" alt="Producto 5">
                                    <div class="text-center mt-2">
                                        <h5>Producto 5</h5>
                                        <p class="text-muted">Descripción breve.</p>
                                    </div>
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <img src="../assets/assets/img/portfolio/6.jpg" class="d-block w-100 rounded" alt="Producto 6">
                                    <div class="text-center mt-2">
                                        <h5>Producto 6</h5>
                                        <p class="text-muted">Descripción breve.</p>
                                    </div>
        ...
        .product-card .card {
            ...
            cursor: pointer; /* Para que parezca un link */
        }

        .product-card .card:hover {
            transform: scale(1.05); /* Aumenta ligeramente el tamaño */
            box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2); /* Sombra para resaltar */
        }
