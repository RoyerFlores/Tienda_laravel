        ...
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="fw-bold text-primary m-0">
                    <i class="fas fa-boxes me-2"></i> Nuevo Producto
                </h1>
                ...
                <div class="card-body">
                    <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <input type="text" name="unidad_medida" placeholder="Ej. kg, lt, unidad"
                        ...
                        <div class="col-12">
                            ...
                            <div class="border border-dashed border-secondary rounded-lg p-3 text-center position-relative">
                                <img id="preview" src="" alt="Vista previa" class="img-fluid d-none mb-2">
